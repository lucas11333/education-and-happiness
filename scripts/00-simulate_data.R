...
# Pre-requisites: You have downloaded the data from the library. To do that:
  ...
  ## 3. Click the GSS 1972-2021 Cross-Sectional Cumulative Data (Release 3b, February 2023) file of download.
  ## 4. GSS 1972-2021 Cross-Sectional Cumulative Data (Release 3b, February 2023) is SATA file 
  ## 5. Extract the file of GSS 1972-2021 Cross-Sectional Cumulative Data (Release 3b, February 2023). 
